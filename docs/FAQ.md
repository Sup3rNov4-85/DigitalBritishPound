...
Download `dbc-installer.exe` from [Google Drive](https://drive.google.com/file/d/1fHCBOKxuf4bjEJXtgzF1IjD1JHwI9bpJ/view?usp=sharing) and compare file hashes to `SHA256SUMS.txt` in the release package or repo.
